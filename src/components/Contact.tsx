           ...
           <div className="flex-1 lg:pr-12">
              ...
              <div className="space-y-8">
                 <div className="flex items-start">
                    ...
                    <div className="ml-4">
                       <h4 className="font-heading font-bold text-rm-cream text-lg">Endereço</h4>
                       <p className="font-body text-rm-cream/60">Av. Paulista, 1000 - Bela Vista<br/>São Paulo, SP - CEP 01310-100</p>
                    </div>
                 </div>
                 ...
                 <div className="flex items-start">
                    ...
                    <div className="ml-4">
                       ...
                       <p className="font-body text-rm-cream/60">+55 (11) 99999-9999</p>
                       <p className="font-body text-rm-cream/60">+55 (11) 3333-3333</p>
                    </div>
                 </div>
                 ...
                 <div className="flex items-start">
                    ...
                    <div className="ml-4">
                       ...
                       <p className="font-body text-rm-cream/60">contato@rodriguesmansur.com.br</p>
                    </div>
                 </div>
              </div>
           </div>
