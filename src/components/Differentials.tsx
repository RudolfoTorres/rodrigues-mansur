    ...
    <section className="bg-rm-cream py-24 border-t border-black/5">
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
        <div className="flex flex-col lg:flex-row items-center gap-16">
          ...
          {/* Image Placeholder - Estrutura Original */}
          <div className="w-full lg:w-1/2 aspect-square max-h-[600px] bg-white rounded-[2rem] p-4 shadow-xl shadow-black/5 border border-black/5 relative overflow-hidden group">
            ...
            {/* Gradiente reforçado + Drop Shadow no texto para contraste total */}
            <div className="absolute inset-x-0 bottom-0 p-8 bg-gradient-to-t from-black/95 via-black/70 to-transparent rounded-b-2xl">
              <span className="font-heading font-bold text-rm-gold text-2xl block drop-shadow-md">
                Mais Performance
              </span>
              <p className="font-body text-white font-medium text-sm sm:text-base mt-1 drop-shadow-md">
                Dados reais, decisões em tempo real.
              </p>
            </div>
          </div>
